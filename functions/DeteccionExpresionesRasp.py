...
def deteccion_expresiones(cap, detector_rostros, red_convolucional, verbose:bool = False, mostrar_ima:bool = False):
    ...
    frame,flag = detectar_rostro(frame, detector_rostros) #Detección del rostro
    ...
    if flag != 0:
        ...
        # output = red_convolucional.get_output_details()[0]
        # print(output)
        predicciones = red_convolucional.get_tensor(32)[0]
